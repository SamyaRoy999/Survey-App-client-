        ...
        <div>
            ...
            <div className="flex justify-center mb-4">
                <button
                    ...
                    className={`mr-2 px-4 py-2 rounded ${viewType === 'table' ? 'bg-[#0E6251] text-white' : 'bg-gray-200 text-gray-700'}`}
                >
                    Table View
                </button>
                <button
                    onClick={() => setViewType('chart')}
                    className={`px-4 py-2 rounded ${viewType === 'chart' ? 'bg-[#0E6251] text-white' : 'bg-gray-200 text-gray-700'}`}
                >
                    Chart View
                </button>
            </div>
