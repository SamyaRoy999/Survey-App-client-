...
const Navbar = () => {
    ...
    const navlink = <>
        ...
        <NavLink to='/survayApp'><li>App</li></NavLink>
        <NavLink to='/survey'><li>Survey</li></NavLink>
        <NavLink to='/Pro-user'><li>Pro-user</li></NavLink>
        <NavLink to='/dashboard'><li>Deshboard</li></NavLink>
    </>
    return (
        <div className="navbar fixed top-0 left-0 right-0 max-w-screen-xl  mx-auto z-10 bg-stone-700  bg-opacity-10">
            <div className="navbar-start">
                <div className="dropdown">
                    <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </div>
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52  gap-3 flex font-Josefin text-base">
                        {navlink}
                    </ul>
                </div>
            ...
            <div className="navbar-end">
                {user ? <><a className="flex  items-center font-bold  text-sm lg:text-lg font-montserrat cursor-pointer  text-[#0E6251] " onClick={() => signOutUser()}> <FiLogOut className='text-xl ' /> Logout</a>
                    <div className="">
                        <div className="group relative cursor-pointer  px-4">
                            ...
                            <div className="flex items-center  justify-between space-x-5 p-1  ">
                                <a className="menu-hover  " onClick="">
                                    <div className="avatar border-4 rounded-full  border-[#0E6251] p-1">
                    ...
                    </div></> : <Link to='./login'><button className='flex gap-1 items-center font-bold text-base lg:text-lg font-montserrat btn-md  btn btn-outline text-[#0E6251] '><CiLogin className='text-xl' /> Login</button></Link>}
